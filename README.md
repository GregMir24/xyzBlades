...
2. Запустите файл download_models_and_setup, который загрузит все необходимые модели и настройки, после чего запустите файл rand_gen.py, генерирующий карту со случайно расставленными зданиями в количестве 5 штук.
3. Откройте Gazebo.
